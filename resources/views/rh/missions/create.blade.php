...
<div class="page-header d-flex justify-content-between align-items-center">
    <div>
        ...
        <p class="text-muted mb-0">Planifier une mission ou un deplacement professionnel</p>
    </div>
...
<form action="{{ route('rh.missions.store') }}" method="POST">
    @csrf
        ...
        <div class="card-body">
            <div class="row g-3">
                ...
                <div class="col-12 col-md-6">
                    ...
                    <input type="number" step="0.01" min="0" name="budget" id="budget" class="form-control @error('budget') is-invalid @enderror" value="{{ old('budget') }}">
                    @error('budget')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                <div class="col-12 col-md-6">
                    ...
                    <input type="number" step="0.01" min="0" name="frais_reels" id="frais_reels" class="form-control @error('frais_reels') is-invalid @enderror" value="{{ old('frais_reels') }}">
                    @error('frais_reels')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
