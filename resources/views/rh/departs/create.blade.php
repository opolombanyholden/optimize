...
@section('breadcrumb')
    <ol class="breadcrumb mb-0">
        ...
        <li class="breadcrumb-item active">Nouveau depart</li>
    </ol>
@endsection
...
<div class="page-header d-flex justify-content-between align-items-center">
    <div>
        ...
        <p class="text-muted mb-0">Enregistrer une sortie d'effectif</p>
    </div>
...
<form action="{{ route('rh.departs.store') }}" method="POST">
    @csrf
                ...
                <div class="col-12 col-md-6">
                    ...
                    <select name="type_depart" id="type_depart" class="form-select @error('type_depart') is-invalid @enderror" required>
                        ...
                        @foreach(\App\Models\Depart::TYPES as $key => $label)
                            <option value="{{ $key }}" {{ old('type_depart') == $key ? 'selected' : '' }}>{{ $label }}</option>
                        @endforeach
                    </select>
                    @error('type_depart')
                        <div class="invalid-feedback">{{ $message }}</div>
        ...
        <div class="card-body">
            <div class="row g-3">
                ...
                <div class="col-12 col-md-4">
                    ...
                    <input type="date" name="date_solde_tout_compte" id="date_solde_tout_compte" class="form-control @error('date_solde_tout_compte') is-invalid @enderror" value="{{ old('date_solde_tout_compte') }}">
        ...
        <div class="card-body">
            <div class="row g-3">
                <div class="col-12 col-md-6">
                    ...
                    <input type="number" step="0.01" min="0" name="indemnite_depart" id="indemnite_depart" class="form-control @error('indemnite_depart') is-invalid @enderror" value="{{ old('indemnite_depart') }}">
                ...
                <div class="col-12 col-md-6">
                    ...
                    <input type="number" step="0.5" min="0" name="solde_conges_paye" id="solde_conges_paye" class="form-control @error('solde_conges_paye') is-invalid @enderror" value="{{ old('solde_conges_paye') }}">
            ...
            <div class="row g-3">
                <div class="col-12 col-md-6">
                    <div class="form-check">
                        ...
                        <input class="form-check-input" type="checkbox" name="preavis_effectue" value="1" id="preavis_effectue" {{ old('preavis_effectue') ? 'checked' : '' }}>
                ...
                <div class="col-12 col-md-6">
                    <div class="form-check">
                        ...
                        <input class="form-check-input" type="checkbox" name="entretien_sortie_effectue" value="1" id="entretien_sortie_effectue" {{ old('entretien_sortie_effectue') ? 'checked' : '' }}>
                ...
                <div class="col-12">
                    ...
                    <textarea name="notes_entretien_sortie" id="notes_entretien_sortie" class="form-control @error('notes_entretien_sortie') is-invalid @enderror" rows="3">{{ old('notes_entretien_sortie') }}</textarea>
                ...
                <div class="col-12 col-md-6">
                    ...
                    <select name="statut" id="statut" class="form-select @error('statut') is-invalid @enderror">
                        <option value="0" {{ old('statut', 0) == 0 ? 'selected' : '' }}>Annonce</option>
                        <option value="1" {{ old('statut') === '1' ? 'selected' : '' }}>En cours</option>
                        <option value="2" {{ old('statut') === '2' ? 'selected' : '' }}>Finalise</option>
                    </select>
                    @error('statut')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
